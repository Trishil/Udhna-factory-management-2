      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-3 flex flex-col md:flex-row items-center justify-between gap-3">
        <div className="flex items-center flex-wrap gap-2 w-full md:w-auto">
          ...
          >
            ...
            <span className={`px-1.5 py-0.2 rounded text-[10px] ${viewMode === 'matrix' ? 'bg-white/20 text-white' : 'bg-blue-100 text-blue-800'}`}>
              Breakdown
            </span>
          </button>
          ...
          >
            ...
            <span className={`px-1.5 py-0.2 rounded text-[10px] ${viewMode === 'pieces' ? 'bg-white/20 text-white' : 'bg-rose-100 text-rose-800 font-mono font-bold'}`}>
              Unit Split / Alter
            </span>
          </button>
          ...
          >
            ...
            <span className={`px-1.5 py-0.2 rounded text-[10px] ${viewMode === 'slips' ? 'bg-white/20 text-white' : 'bg-amber-100 text-amber-900'}`}>
              S V ART
            </span>
          </button>
        </div>
        ...
        <div className="flex items-center flex-wrap gap-2 w-full md:w-auto justify-end">
          ...
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs font-black shadow-md shadow-blue-500/20 transition-all hover:scale-[1.02]"
            title="Create Master Order Folder (Order Slip) or Branch New Fabric Design"
          >
            <FolderTree className="h-4 w-4" />
            <span>+ New Order &amp; Design (Folder &amp; Branch)</span>
          </button>
          ...
          {onTriggerSync && (
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-2 rounded-xl bg-teal-700 hover:bg-teal-600 text-xs font-bold text-white shadow-xs transition-all"
              title="Sync All Workflow Designs to Google Sheets (Shared with drlaljirpatel@gmail.com & trishilbalar@gmail.com)"
            >
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold transition-colors"
            title="Export CSV"
          >
      ...
      {viewMode === 'kanban' && (
        ...
        <div className="p-5 bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 text-white flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-center space-x-3">
            <div className="p-2.5 rounded-xl bg-blue-600 shadow-md shadow-blue-500/30">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="px-2 py-0.5 rounded-md bg-blue-500/30 border border-blue-400/40 text-blue-200 text-[10px] font-mono font-extrabold uppercase">
                  10 Stages Kanban
                </span>
              </div>
          ...
          <div className="flex items-center flex-wrap gap-2 w-full md:w-auto justify-between md:justify-end">
            ...
            {/* Google Sheets Collaborators Access Indicator */}
            <div className="hidden xl:flex items-center space-x-1.5 px-2.5 py-1.5 rounded-lg bg-teal-950/60 border border-teal-500/40 text-teal-200 text-[11px] font-medium">
              <Users className="h-3.5 w-3.5 text-teal-400" />
              <span>Sheet access: drlaljirpatel@gmail.com &amp; trishilbalar@gmail.com</span>
            </div>
            ...
            {onTriggerSync && (
              <button
                ...
                type="button"
                onClick={onTriggerSync}
                className="flex items-center space-x-1.5 px-3 py-2 rounded-xl bg-teal-700 hover:bg-teal-600 border border-teal-600 text-xs font-bold text-white shadow-md shadow-teal-700/20 transition-all hover:scale-[1.02]"
                title="Sync All Workflow Designs to Google Sheets (Grants access to drlaljirpatel@gmail.com & trishilbalar@gmail.com)"
              >
                <RefreshCw className="h-4 w-4" />
                <span>Sync Sheets</span>
              </button>
            ...
            <button
              ...
              type="button"
              onClick={handleExportCSV}
              className="flex items-center space-x-1.5 px-3 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-xs font-bold text-slate-200 transition-colors"
            >
              <Download className="h-3.5 w-3.5" />
            ...
            <button
              ...
              type="button"
              onClick={() => setIsCreateModalOpen(true)}
              className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white rounded-xl text-xs font-black shadow-lg shadow-blue-600/30 transition-all hover:scale-[1.02] active:scale-[0.98]"
              title="Create Master Order Folder (Order Slip) or Branch New Fabric Design"
            >
              <FolderTree className="h-4 w-4" />
              <span>+ New Order &amp; Design (Folder &amp; Branch)</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 divide-x divide-y sm:divide-y-0 divide-slate-100 bg-slate-50 text-xs">
          <div className="p-3.5 flex items-center space-x-3">
            <div className="p-2 rounded-lg bg-blue-100 text-blue-800">
              <Package className="h-4 w-4" />
            </div>
            <div>
              <span className="text-[10px] uppercase font-bold text-slate-400">Total in Pipeline</span>
              <p className="text-base font-black text-slate-900 font-mono">{totalItems} Jobs</p>
            </div>
          </div>
          ...
          <div className="p-3.5 flex items-center space-x-3">
            ...
            <div>
              <span className="text-[10px] uppercase font-bold text-slate-400">In Embroidery</span>
              <p className="text-base font-black text-purple-700 font-mono">{inEmbroideryCount} Active</p>
            </div>
          </div>

          <div className="p-3.5 flex items-center space-x-3">
            <div className={`p-2 rounded-lg ${urgentCount > 0 ? 'bg-rose-100 text-rose-800' : 'bg-slate-100 text-slate-500'}`}>
              <Flame className="h-4 w-4" />
            </div>
            <div>
              <span className="text-[10px] uppercase font-bold text-slate-400">Urgent Priority</span>
              <p className={`text-base font-black font-mono ${urgentCount > 0 ? 'text-rose-600' : 'text-slate-800'}`}>
                {urgentCount} Lots
              </p>
            </div>
          </div>
          ...
          <div className="p-3.5 flex items-center space-x-3">
            <div className={`p-2 rounded-lg ${alteringCount > 0 ? 'bg-yellow-100 text-yellow-800' : 'bg-slate-100 text-slate-500'}`}>
              <Wrench className="h-4 w-4" />
            </div>
            <div>
              <span className="text-[10px] uppercase font-bold text-slate-400">Altering / Rework</span>
              <p className={`text-base font-black font-mono ${alteringCount > 0 ? 'text-yellow-800' : 'text-slate-800'}`}>
                {alteringCount} Items
              </p>
            </div>
          </div>
          ...
          <div className="p-3.5 flex items-center space-x-3">
            ...
            <div>
              <span className="text-[10px] uppercase font-bold text-slate-400">Ready for Dispatch</span>
              <p className="text-base font-black text-emerald-700 font-mono">{readyDispatchCount} Lots</p>
            </div>
          </div>
        </div>
